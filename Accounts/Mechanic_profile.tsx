...
export const Mechanic_Profile = (props: {
  ...
  return (
    <View style={styles.outerContainer}>
      <ScrollView style={styles.scroll}>
        ...
        <TouchableOpacity style={styles.vehicle_container}  onPress={() => props.navigation.navigate('Update_kyc')}>
            <View>
          <Text style={styles.vehicle_name}>Update KYC (Pending)</Text>
          {/* <Text style={styles.phone}>Johndeo@gmail.com</Text> */}
          </View>
          <TouchableOpacity>
            <View style={styles.iconTextContainer}>
...
export default Mechanic_Profile;
