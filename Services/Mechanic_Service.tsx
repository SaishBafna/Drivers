...
export const Mechanic_Service_page = (props: { navigation: { navigate: (arg0: string) => void; }; }) => {
    ...
    <View style={styles.outerContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.service_section}>
          <Text style={styles.service_text}>Request Services</Text>
...
export default Mechanic_Service_page;
